    ...
    <S.Container flex={false}>
        <S.RecruitContainer>
            ...
            <S.Container flex={true}>
                ...
                <S.InputList><S.Input type="checkbox" name="color" value="sw" />임베디드과 (</S.InputList>
                <S.InputList><S.Input type="text" />) 명</S.InputList>
                <S.InputList><S.Input type="checkbox" name="color" value="sw" />정보보안과 (</S.InputList>
                <S.InputList><S.Input type="text" />) 명</S.InputList>
                <S.InputList><S.Input type="checkbox" name="color" value="sw" />학과무관 (</S.InputList>
                <S.InputList><S.Input type="text" />) 명</S.InputList>
            </S.Container>
            <S.Container flex={true}>
                <S.Container flex={false}>
