      ...
      <S.RecruitContainer>
        <S.InnerContainer>
          <S.Container flex={true}>
            ...
            <S.InputList>
              <S.Input type="checkbox" name="color" value="sw" />
              SW 개발과 (
            </S.InputList>
            <S.InputList>
              <S.Input type="text" />) 명
            ...
            <S.InputList>
              <S.Input type="checkbox" name="color" value="em" />
              임베디드과 (
            </S.InputList>
            <S.InputList>
              <S.Input type="text" />) 명
            ...
            <S.InputList>
              <S.Input type="checkbox" name="color" value="info" />
              정보보안과 (
            </S.InputList>
            <S.InputList>
              <S.Input type="text" />) 명
            ...
            <S.InputList>
              <S.Input type="checkbox" name="color" value="none" />
              학과무관 (
            </S.InputList>
            <S.InputList>
              <S.Input type="text" />) 명
          ...
          <S.Container>
            ...
            <S.InputLine type="text" width="small"></S.InputLine>
            <S.Span>년</S.Span>
            <S.InputLine type="text" width="small"></S.InputLine>
            <S.Span>월</S.Span>
            <S.InputLine type="text" width="small"></S.InputLine>
